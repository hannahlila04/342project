...
class Clock(Frame):
    ...
    def record_dance(self):
        ...
        # record()
        command = f" ssh anooprehman@172.20.10.6 '/Library/Frameworks/Python.framework/Versions/3.9/bin/python3.9 /Users/anooprehman/Documents/uoft/extracurricular/hackathons/makeuoft/342project/camera_stuff.py'"
